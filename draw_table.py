...
def table_gener(size):
    ...
    pdfmetrics.registerFont(TTFont('Autoproject', f'{BASE_DIR}\\func\Autoproject.ttf'))  # Замените 'Autoproject' на путь к файлу шрифта
    # pdfmetrics.registerFont(TTFont('Autoproject', f'G:/1stepPython/Loft_drawing/website/func/Autoproject.ttf'))  # Замените 'Autoproject' на путь к файлу шрифта
